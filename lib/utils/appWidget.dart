...
Widget placeHolderWidget({double? height, double? width, BoxFit? fit, AlignmentGeometry? alignment, double? radius}) {
  return Image.asset(ic_logo, height: height, width: width, fit: fit ?? BoxFit.cover, alignment: alignment ?? Alignment.center).cornerRadiusWithClipRRect(radius ?? defaultRadius);
}
...
Widget noDataWidget(BuildContext context) {
  return Column(
    ...
    children: [
      Lottie.asset(ic_noData, fit: BoxFit.cover, height: 100, width: 100),
      8.height,
